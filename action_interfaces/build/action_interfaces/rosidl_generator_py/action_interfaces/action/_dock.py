...
class Dock_SendGoal_Request(metaclass=Metaclass_Dock_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'action_interfaces/Dock_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['action_interfaces', 'action'], 'Dock_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from action_interfaces.action._dock import Dock_Goal
...
class Metaclass_Dock_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.Dock_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from action_interfaces.action import _dock
...
class Dock_SendGoal(metaclass=Metaclass_Dock_SendGoal):
    from action_interfaces.action._dock import Dock_SendGoal_Request as Request
    from action_interfaces.action._dock import Dock_SendGoal_Response as Response
...
class Dock_GetResult_Response(metaclass=Metaclass_Dock_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'action_interfaces/Dock_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['action_interfaces', 'action'], 'Dock_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from action_interfaces.action._dock import Dock_Result
...
class Metaclass_Dock_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.Dock_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Dock_GetResult(metaclass=Metaclass_Dock_GetResult):
    from action_interfaces.action._dock import Dock_GetResult_Request as Request
    from action_interfaces.action._dock import Dock_GetResult_Response as Response
...
class Metaclass_Dock_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.Dock_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Dock_FeedbackMessage(metaclass=Metaclass_Dock_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'action_interfaces/Dock_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['action_interfaces', 'action'], 'Dock_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from action_interfaces.action._dock import Dock_Feedback
...
class Dock(metaclass=Metaclass_Dock):
    ...
    from action_interfaces.action._dock import Dock_Goal as Goal
    # The result message defined in the action definition.
    from action_interfaces.action._dock import Dock_Result as Result
    # The feedback message defined in the action definition.
    from action_interfaces.action._dock import Dock_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from action_interfaces.action._dock import Dock_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from action_interfaces.action._dock import Dock_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from action_interfaces.action._dock import Dock_FeedbackMessage as FeedbackMessage
