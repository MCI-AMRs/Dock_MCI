...
class ImageSubscriber(Node):
    ...
    def drive_straight(self):
        ...
        if self.stop == False:
            ...
            self.get_logger().info("Translation Action finished")
    ...
    def control_angle(self):
        ...
        self.get_logger().info("goal_send to robot")
    ...
    def qr_scan(self):
        ...
        if retval == True and corners is not None:
            ...
            self.get_logger().info(f'Angle error: {self.angle*180/math.pi}°\n')
            ...
            self.get_logger().info('No QR found')
            self.error = None
